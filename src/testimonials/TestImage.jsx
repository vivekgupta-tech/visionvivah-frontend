...
<h1 className='destination-titles relative font-extrabold text-center  text-white text-7xl  pt-24'>Testimonials</h1>
 <div className='flex'>
 ...
 <li className="hover:border-b-2 border-white"><NavLink to = "/">Home</NavLink></li>
    <li >/</li>
    <li className="hover:border-b-2 border-white">Testimonials</li>
 </ul>
</div>
</div>
    </>
