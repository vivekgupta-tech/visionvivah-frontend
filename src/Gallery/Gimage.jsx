...
<div className="pt-28 h-[80vh]">
    <div className="relative bg-cover bg-center h-[100%] " style={{ backgroundImage:"url('https://www.visionvivaah.com/gallery-image/banner/1565003834.jpg')",}}>
<div className="absolute inset-0 bg-sky-900 bg-opacity-60"></div>

<h1 className='destination-titles relative font-extrabold text-center  text-white text-7xl  pt-24'>Our Gallery</h1>
 <div className='flex'>
 ...
 <li className="hover:border-b-2 border-white"><NavLink to = "/">Home</NavLink></li>
    <li >/</li>
    <li className="hover:border-b-2 border-white">Our Gallery</li>
 </ul>
</div>
</div>
    </>
