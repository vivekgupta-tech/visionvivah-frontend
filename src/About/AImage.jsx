...
<div className="pt-28 h-[80vh]">
    <div className="relative bg-cover bg-center h-[100%] " style={{ backgroundImage:"url('https://www.visionvivaah.com/cms/about-us.jpg')",}}>
<div className="absolute inset-0 bg-sky-900 bg-opacity-60"></div>

<h1 className='destination-titles relative font-extrabold text-center  text-white text-7xl  pt-24'>about Us</h1>
 <div className='flex'>
